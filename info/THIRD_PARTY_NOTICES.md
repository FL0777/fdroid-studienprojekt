...
Diese Datei enthält eine Übersicht der im Projekt verwendeten Open-Source-Software und der zugehörigen Lizenzen.

## Überblick

Diese App verwendet Open-Source-Bibliotheken aus dem Android-, Kotlin- und Backend-Ökosystem sowie weitere Komponenten für UI, Kamera, Datenvisualisierung und Benachrichtigungen.
...
- Lizenz: CC0, CC-BY und andere Creative Commons-Lizenzen
- Quelle: https://commons.wikimedia.org/
- Verwendung: Pflanzenkatalog-Bilder werden von Wikimedia Commons abgerufen und entsprechend ihrer jeweiligen Lizenz verwendet.

### App-Icons & Grafische Elemente
- Generator: Microsoft Copilot (KI-generiert)
- Quelle: https://copilot.microsoft.com/
- Verwendung: Die App-Icons und weitere grafische Elemente wurden mit Hilfe von Microsoft Copilot KI-generiert.

---

## Creative Commons-Lizenzen

Weitere Informationen zu Creative Commons-Lizenzen finden Sie unter: https://creativecommons.org/
